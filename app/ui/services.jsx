export default function Services() {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">Designed for business teams like yours</h2>
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              ...
              <p class="text-gray-500 dark:text-gray-400 ml-3">Plan it, create it, launch it. Collaborate seamlessly with all  the organization and hit your marketing goals every month with our marketing plan.</p>
          </div>
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400 ml-3">Protect your organization, devices and stay compliant with our structured workflows and custom permissions made for you.</p>
          </div>
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400 ml-3">Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help you get started.</p>
          </div>
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400 ml-3">Audit-proof software built for critical financial operations like month-end close and quarterly budgeting.</p>
          </div>
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400 ml-3">Craft beautiful, delightful experiences for both marketing and product with real cross-company collaboration.</p>
          </div>
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p class="text-gray-500 dark:text-gray-400 ml-3">Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
          </div>
      </div>
  </div>
</section>
