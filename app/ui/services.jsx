  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white ml-3">Digital Marketing</h3>
          ...
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white ml-3">Android Development</h3>
          ...
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white ml-3">Digital Automation</h3>
          ...
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white ml-3">SEO</h3>
          ...
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white ml-3">SEM</h3>
          ...
          <div className="border p-2 rounded-lg hover:bg-zinc-900 cursor-pointer hover:border-2">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white ml-3">Digital Growth</h3>
